...
public class StartPiece
{
    ...
    public StartPiece(int nbbombe_, int nbMarechal_, int nbgeneral_, int nbcolonel_, int nbcommandant_, int nbcapitaine_, int nbLieutenant_, int nbsergent_, int nbdemineur_, int nbeclaireur_, int nbespion_)
    {
